...
<p><img style="float: left; margin: 0px 15px 15px 0px;" src="../graphics/checkbox.png"> In the case where the updater displays that there are pending updates, apply them. 
<p><img style="float: left; margin: 0px 15px 15px 0px;" src="../graphics/checkbox.png"> In the case where the updater displays that all updates are current, click the option to "Search for updates" to ensure that message is current.</p>
<p><img style="float: left; margin: 0px 15px 15px 0px;" src="../graphics/checkbox.png"> In the case of an error when trying to apply updates, follow the steps </a href="https://support.microsoft.com/en-us/sbs/windows/fix-windows-update-errors-18b693b5-7818-5825-8a7e-2a4a37d6d787"> in this Microsoft Support article to correct them</a>.</p>
...
- Virus and threat protection: Information and access to antivirus, ransomware protection, and settings and notifications including Controlled folder access and sign-in to Microsoft OneDrive.
...
<p><img style="float: left; margin: 0px 15px 15px 0px;" src="../graphics/checkbox.png">  Watch <A href="https://www.microsoft.com/en-us/videoplayer/embed/RE3FifU">This video from Microsoft</a> to help understand the role of virus and threat protection. </p>
...
<p><img style="margin: 0px 15px 15px 0px;" src="../graphics/checkmark.png"><b>Description</b></p>
<p>In this step you will configure application and browser control.</p>
...
<p><img style="float: left; margin: 0px 15px 15px 0px;" src="../graphics/checkbox.png">  Consider using Microsoft's Defender Application guard with Edge for a very secure browsing environment. (not avaliable on all devices)</p>
<p><img style="float: left; margin: 0px 15px 15px 0px;" src="../graphics/checkbox.png">  Watch <A href="https://www.microsoft.com/en-us/videoplayer/embed/RE4rsD6">This video from Microsoft</a> to help understand the role of application and browser control. </p>
...
<p><img style="float: left; margin: 0px 15px 15px 0px;" src="../graphics/checkbox.png">  OPTIONAL: <a href="https://www.microsoft.com/en-us/download/details.aspx?id=7826" target="_blank">download the MAP toolkit from Microsoft for free here.</a> Review the sample reports and run a scan of your own system.</p>
