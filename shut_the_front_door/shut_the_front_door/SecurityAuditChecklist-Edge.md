...
>Always ensure the user has a complete backup of their system before making any changes. Loss of data can occur with some of the actions below.
...
The second most common security vector is the exploitation of a vulnerable system. You should continue your security audit by guiding the user through your organization's security and acceptable use policies, and reinforce their understanding of the software and hardware they are responsible for.
<br>
...
>NOTE: Each of these peripherals represents a potential seucity vector, and each will have its own security checklist you should create using the link above. 

<h2 id="Updates"><img style="float: left; margin: 0px 15px 15px 0px;" src="../graphics/pencil2.png">03 - Patches and Updates</h2>
To protect systems, technology vendors regularly publish updates to software and hardware drivers. You should continue your security audit by guiding the user through the updating process, and reinforce their understanding of the process and necessity of maintaining and up-to-date system.
<br>
...
Arguably the best, and also most dangerous, part of using a computer is when it connects to the public Internet. Finish your security audit by walking the user through safe browsing, emailing, and internet usage. 
<br>
