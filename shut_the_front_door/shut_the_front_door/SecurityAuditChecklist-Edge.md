...
<p><img style="margin: 0px 15px 15px 0px;" src="../graphics/checkbox.png">  Explain the appropriate updating process - ensure there are no pending updates.</p>
<p><img style="margin: 0px 15px 15px 0px;" src="../graphics/checkbox.png">  Use <a href="https://support.microsoft.com/en-us/windows/update-drivers-in-windows-10-ec62f46c-ff14-c91d-eead-d7126dc1f7b6">device manager</a> to check for any missing drivers quickly, or each manufacturer website.</p>
...
<p><img style="margin: 0px 15px 15px 0px;" src="../graphics/checkbox.png">  Ensure <a href="https://docs.microsoft.com/en-us/windows/security/identity-protection/user-account-control/user-account-control-overview">User Account Control</a> is configured appropriately.</p>
...
<p><img style="margin: 0px 15px 15px 0px;" src="../graphics/checkbox.png">  Explain the firewall's purpose and configuration.</p>
<p><img style="margin: 0px 15px 15px 0px;" src="../graphics/checkbox.png">  Guide the user through checking the firewall and any port forwarding rules currently set.</p>
<p><img style="margin: 0px 15px 15px 0px;" src="../graphics/checkbox.png">  Guide the user through checking the firewall logs.</p>
...
<p><img style="margin: 0px 15px 15px 0px;" src="../graphics/checkbox.png">  Guide the user in making a backup of their data.</p>
